...
namespace Rock.Migrations
{
    ...
    public partial class AutomatedPayments : Rock.Migrations.RockMigration
    {
        ...
        {
            RockMigrationHelper.AddDefinedValue( Rock.SystemGuid.DefinedType.FINANCIAL_CURRENCY_TYPE, "Apple Pay", "Apple Pay", Rock.SystemGuid.DefinedValue.CURRENCY_TYPE_APPLE_PAY, true, 4 );
            RockMigrationHelper.AddDefinedValue( Rock.SystemGuid.DefinedType.FINANCIAL_CURRENCY_TYPE, "Android Pay", "Android Pay", Rock.SystemGuid.DefinedValue.CURRENCY_TYPE_ANDROID_PAY, true, 5 );
